...
const createRequest = (
  ...
  const sql = `INSERT INTO child_requests (parent_id, requested_children, child_age, child_image) VALUES (?, ?, ?, ?)`;
  db.query(sql, [parentId, requestedChildren, childAge, childImage], callback);
};
