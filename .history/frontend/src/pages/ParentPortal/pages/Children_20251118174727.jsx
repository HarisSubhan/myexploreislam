...
/* ChildFormModal: Add/Edit child with avatar selection */
const ChildFormModal = ({ show, onHide, onSave, editing, submitting }) => {
  const [form, setForm] = useState({
    ...
    avatar: editing?.avatar ?? "avatar1", // Default avatar
  });
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const submitData = {
        ...
        // Add parent_id for new child
        ...(!editing && { parent_id: JSON.parse(localStorage.getItem("user") || "{}").id || 2 }),
      };
