...
const ParentSupports = () => {
  ...
  const simulateLoginForTesting = () => {
    console.log("Simulating login for testing...");
    // You can manually set test user data here for development
    const testUser = {
      id: 2,
      name: "parent",
      username: "parent",
        ...
        <Card className="shadow-sm border-0 rounded-3">
          <Card.Body className="text-center py-5">
            ...
            <div className="d-flex justify-content-center gap-3">
              ...
              {/* Remove this button in production - for testing only */}
              <Button
                variant="outline-secondary"
                onClick={simulateLoginForTesting}
              >
            ...
            <div className="mt-4 p-3 bg-light rounded">
              <small className="text-muted">
                <strong>Debug Info:</strong> Check if user data exists in
                localStorage. After login, make sure your login page stores:{" "}
                <br />
                <code>
                  localStorage.setItem('user', JSON.stringify(userData))
                </code>{" "}
                <br />
                <code>localStorage.setItem('token', token)</code>
              </small>
            </div>
          </Card.Body>
        </Card>
