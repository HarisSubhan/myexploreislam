...
import { useUser } from "../path-to-your-context/UserContext"; // Update the path accordingly
...
const Subscription = () => {
  ...
  const fetchSubscriptionData = async () => {
    try {
      ...
      // Fetch subscription details using the user ID from context
      const subscriptionResponse = await axios.get(
        `${baseUrl}/api/parent-dashboard/${user.id}/subscription`,
        {
          headers: {
      ...
      if (subscriptionResponse.data.data) {
        ...
        generateInvoicesFromSubscription(subscriptionResponse.data.data);
      } else {
