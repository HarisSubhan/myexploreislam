...
const LearningReports: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'subjects' | 'assignments' | 'report'>('subjects');
  ...
  const reportCard: ReportCard = {
    ...
    subjects: subjects,
    overallGrade: 'A-',
    comments: 'Excellent progress this semester. Shows strong analytical skills and consistent improvement in all subjects.'
  };
          ...
          <div className="subjects-grid">
            {subjects.map(subject => (
              <div key={subject.id} className="subject-card">
                ...
                <div className="progress-text">{subject.progress}% Complete</div>
        ...
        {activeTab === 'report' && (
          <div className="report-card-section">
            <div className="report-card-actions">
              <button onClick={handlePrintReport} className="action-button print">
                Print Report
              </button>
              <button onClick={handleEmailReport} className="action-button email">
                Email Report
              </button>
            </div>
            ...
            <div className="report-card printable">
              <div className="report-header">
                ...
                <div className="student-info">
                  <p><strong>Student:</strong> {reportCard.studentName}</p>
                  <p><strong>ID:</strong> {reportCard.studentId}</p>
                  <p><strong>Period:</strong> {reportCard.period}</p>
                </div>
              </div>
