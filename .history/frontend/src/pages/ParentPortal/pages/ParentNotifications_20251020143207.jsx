...
import { getRecentActivity } from "./your-api-file"; // Adjust the import path
...
const ParentNotifications = ({ parentId }) => {
  ...
  // Transform API response to match our notification forma
  const transformApiResponse = (apiData) => {
    ...
    return apiData.map((activity, index) => ({
      ...
      // Include any other relevant fields from your API
      ...activity,
    }));
  };
