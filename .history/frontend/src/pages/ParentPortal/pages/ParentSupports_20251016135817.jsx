...
const ParentSupports = () => {
  ...
  // Fetch tickets and summary on component mount
  useEffect(() => {
    fetchTickets();
    fetchSummary();
  }, []);
              ...
              <Col md={3} sm={6}>
                <Card className="border-0 shadow-sm bg-success text-white">
                  <Card.Body>
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <h4 className="fw-bold">{summary.resolved_tickets}</h4>
            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <small className="text-muted">
                  {tickets.length} ticket(s) in total
                </small>
                <Button
                  variant="primary"
            ...
            <Card.Body>
              ...
              <Accordion defaultActiveKey="0" className="mb-4">
                ...
                <Accordion.Item eventKey="3">
                  <Accordion.Header>📚 Book download issues</Accordion.Header>
                  <Accordion.Body>
                    Ensure you have stable internet connection and sufficient
                    storage space. If issues persist, contact support with the
                    specific book title.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              ...
              <div className="mt-3 p-3 bg-info bg-opacity-10 rounded">
                <h6 className="fw-bold">Support Information</h6>
                <small className="text-muted">
