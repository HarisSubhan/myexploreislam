...
const Subscription = () => {
  ...
  const fetchSubscriptionData = async () => {
    try {
      ...
      // In a real app, you might get parentId from user context or auth
      const token = getToken();
      const userParentId = 2; // This should come from your auth context
      setParentId(userParentId);

      // Fetch subscription details
      const subscriptionResponse = await axios.get(
        `${baseUrl}/api/parent-dashboard/${userParentId}/subscription`,
        {
          headers: {
