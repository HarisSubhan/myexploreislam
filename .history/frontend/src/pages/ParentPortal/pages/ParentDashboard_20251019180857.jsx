...
import React, { useState } from "react";
import { Container, Row, Col } from "react-bootstrap";
import { useParentMetrics } from "./useParentMetrics";
import DateRangeFilter from "./DateRangeFilter";
import StatCards from "./StatCards";
import SubscriptionWidget from "./SubscriptionWidget";
import ActivityTimeline from "./ActivityTimeline";
import ChildActivityTable from "./ChildActivityTable";
import MultiChildChart from "./MultiChildChart";
...
const ParentDashboard = () => {
  ...
  console.log("Dashboard - Real API Combined Activity:", combinedActivity);
  console.log("Dashboard - Real API Children Data:", children);
