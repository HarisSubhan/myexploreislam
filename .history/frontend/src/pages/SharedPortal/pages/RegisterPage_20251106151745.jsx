...
import { MockRegisterApi } from "../../../services/mockApi"; // Mock API use karein
...
const RegisterPage = () => {
  ...
  useEffect(() => {
    if (location.state?.subscription_id) {
      ...
      // Mock subscription ID agar nahi mila toh
      setSubscriptionId("plan_standard");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Mock API use karein
      const res = await MockRegisterApi({
        ...form,
        subscription_id,
      });
      ...
      // Mock Stripe checkout URL mili hai
      if (res && res.stripeCheckoutUrl) {
        setSuccess("Registration successful! Redirecting to payment...");
        
        // Mock Stripe page par redirect karein
        setTimeout(() => {
          navigate("/mock-stripe-checkout", {
            state: {
              userData: form,
            ...
            <div style={{ maxWidth: "400px", width: "100%" }}>
              <div className="text-center mb-4">
                ...
                <Alert variant="info" className="small">
                  <strong>Demo Mode:</strong> Using mock payment system
                </Alert>
              </div>
              ...
              <div className="mt-4 p-3 bg-light rounded">
                ...
                <small className="text-muted">
                  • Use any email except test@example.com<br/>
                  • Password: minimum 6 characters<br/>
                  • Card: 4242424242424242 (success simulation)
                </small>
              </div>
            </div>
          </Col>
