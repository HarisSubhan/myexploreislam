  ...
  const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        // Since the API only returns a message, we'll use the email to identify the user
        // We'll send the email to the checkout session and handle user login after payment
        const checkoutData = {
          ...
          subscription_id: subscriptionData.id,
          user_email: form.email, // Use email instead of user_id
          user_name: form.name
        };
