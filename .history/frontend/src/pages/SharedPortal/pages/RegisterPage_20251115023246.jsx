...
const RegisterPage = () => {
  ...
  useEffect(() => {
    if (location.state?.subscription_id && location.state?.planData) {
      console.log("Received plan data:", location.state.planData);
      setSubscriptionData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!subscriptionData.stripe_price_id) {
        throw new Error("Stripe price ID is missing. Please contact support.");
      }
            ...
            <div style={{ maxWidth: "400px", width: "100%" }}>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  disabled={loading || !subscriptionData || !subscriptionData.stripe_price_id}
                >
              ...
              {!subscriptionData?.stripe_price_id && (
                <Alert variant="warning" className="text-center">
                  <strong>Payment temporarily unavailable</strong><br/>
