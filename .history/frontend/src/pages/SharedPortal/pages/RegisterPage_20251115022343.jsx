...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userId = registrationResponse.user?.id || registrationResponse.id || registrationResponse.userId;
      const userToken = registrationResponse.token || registrationResponse.access_token;
      ...
      const checkoutData = {
        ...
        subscription_id: subscriptionData.id,
        user_id: userId // Use the correct user ID from response
      };
