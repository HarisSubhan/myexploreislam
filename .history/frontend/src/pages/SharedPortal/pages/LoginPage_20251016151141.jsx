  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const userWithId = {
        ...
        id: user.id || user.userId || user._id || user.user_id || Date.now(), // Fallback to timestamp if no ID
      ...
      // Force synchronous storage by reading back immediately
      ...
      console.log("✅ Storage verified:", { verifyUser, verifyToken });
