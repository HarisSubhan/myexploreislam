 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (userId) {
      ...
      // TEMPORARY: Hardcode all required fields
      const checkoutData = {
        parent_id: userId,
        plan_name: subscriptionData.plan_name,
        subscription_id: subscriptionData.id,
        stripe_price_id: "price_1STUv1DttKoZh8aWsX7T1BWm", // ✅ Hardcoded
        price: subscriptionData.price || 10, // ✅ Add price
        max_children: subscriptionData.max_children || 2 // ✅ Add max_children
      };
