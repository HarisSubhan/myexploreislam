...
const RegisterPage = () => {
  ...
  // ✅ ADD THIS FUNCTION - Hardcoded stripe_price_id mapping
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ FIX: Get stripe_price_id from mapping if not in data
      ...
      const checkoutData = {
        ...
        stripe_price_id: stripePriceId, // ✅ Using the resolved price ID
        subscription_id: subscriptionData.id,
