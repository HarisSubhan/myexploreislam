 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (userId) {
      ...
      // Backend ko saari required fields bhejein
      const checkoutData = {
        parent_id: userId,
        plan_name: subscriptionData.plan_name,
        subscription_id: subscriptionData.id,
        price: subscriptionData.price, // ✅ ADD THIS
        max_children: subscriptionData.max_children, // ✅ ADD THIS
        // stripe_price_id backend mein environment variable se aayega
      };
