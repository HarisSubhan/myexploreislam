...
const RegisterPage = () => {
  ...
  try {
    ...
    console.log("Response keys:", Object.keys(registerResponse));
    ...
    } else if (registerResponse.user?.id) {
      userId = registerResponse.user.id;
    } else if (registerResponse.id) {
      userId = registerResponse.id;
    } else if (registerResponse.data?.user_id) {
    ...
    if (userId) {
      ...
      // Agar user_id nahi mila, lekin registration successful hai
      console.warn("User ID not found in response, but registration might be successful");
      
      // Direct Stripe checkout try karein with email
      const checkoutData = {
        plan_name: subscriptionData.plan_name,
        price: subscriptionData.price,
        max_children: subscriptionData.max_children,
      ...
      console.log("Creating checkout without user ID:", checkoutData);
      ...
      if (checkoutResponse && checkoutResponse.url) {
        ...
        throw new Error("Registration completed but payment setup failed");
      }
    }
  } catch (err) {
