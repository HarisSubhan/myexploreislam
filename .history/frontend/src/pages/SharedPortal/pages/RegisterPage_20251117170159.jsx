...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (userId) {
      ...
      const stripePriceId = import.meta.env.VITE_STRIPE_PRICE_ID; // ✅ Correct syntax

      import.meta.env.REACT_APP_IMAGE_BASE_URL
      
      console.log("Stripe Price ID from env:", stripePriceId);
      ...
      const checkoutData = {
        ...
        max_children: subscriptionData.max_children // ✅ Add this if backend needs it
      };
