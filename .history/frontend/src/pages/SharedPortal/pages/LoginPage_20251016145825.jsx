...
function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // FIXED: Ensure user object has proper ID field
      const userWithId = {
        ...user,
        // Ensure we have an 'id' field that ParentSupports can find
      ...
      localStorage.setItem("user", JSON.stringify(userWithId)); // ← FIXED: Store enhanced user object

      console.log("Stored user data:", userWithId); // Debug log
