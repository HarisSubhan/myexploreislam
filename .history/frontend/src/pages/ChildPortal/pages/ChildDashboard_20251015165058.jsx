...
const ChildDashboard = () => {
    ...
    const fetchModules = async () => {
      try {
        ...
        const formattedModules = data.map((module) => {
          // Determine module type based on available data
          const moduleType = module.series_id ? "series" : "single";
  ...
  if (modules.length === 0) {
    return (
      ...
      >
        <div
          className="alert alert-info text-center mx-auto p-5 rounded-3"
          style={{
            maxWidth: "500px",
            background: "rgba(255, 255, 255, 0.95)",
            border: "none",
        ...
        >
          <h5 className="mb-3">No Learning Modules Available</h5>
          <p className="text-muted mb-4">
            There are no learning modules available at the moment. Please check
          ...
          <Col key={module.id} xs={12} sm={8} md={6} lg={4} xl={3}>
            ...
            >
              ...
              <div style={{ position: "relative" }}>
                ...
                {module.type === "series" && module.videoCount > 0 && (
                  <Badge
                    bg="dark"
                  ...
                  >
                    {module.videoCount}{" "}
                    {module.videoCount === 1 ? "video" : "videos"}
                  </Badge>
                )}
              </div>
              ...
              <Card.Body className="d-flex flex-column">
                ...
                <div className="mt-auto">
                  ...
                  >
                    {module.type === "series" ? "View Series" : "Browse Videos"}{" "}
                    →
                  </Button>
                </div>
              </Card.Body>
