...
const handleCardClick = (module) => {
  ...
  // Temporary: Hardcode check
  if (module.title.toLowerCase().includes("series") || module.videoCount > 1) {
    const moduleSlug = createSlug(module.title);
    console.log("🎬 Navigating to SERIES DETAIL");
    navigate(`/child/series/${moduleSlug}`);
  } else {
    console.log("🎥 Navigating to VIDEO MODULES");
