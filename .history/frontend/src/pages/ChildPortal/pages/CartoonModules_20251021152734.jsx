  ...
  useEffect(() => {
    const fetchAllContent = async () => {
      try {
        ...
        const seriesModulesData = modulesData
          .filter((module) => module.name?.toLowerCase().includes("series"))
          .map((module) => ({
            id: module.id,
            title: module.name || module.title || `Module ${module.id}`,
            description: module.description || "Explore learning series",
            ...
            type: "series",
            slug: createSlug(
              module.name || module.title || `series-${module.id}`
            ),
