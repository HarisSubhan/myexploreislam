        ...
        >
          <div className="mb-4">
            ...
            <p className="text-muted mb-4">
              Your session has expired. Please login to access your learning content.
            </p>
          </div>
          <Button
            variant="primary"
  ...
  if (error) {
    return (
      ...
      >
        ...
        >
          <h5 className="alert-heading mb-3">Something went wrong</h5>
    ...
    >
      ...
      {modules.length > 0 ? (
                ...
                <div style={{ position: "relative" }}>
                  {module.thumbnail ? (
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "https://via.placeholder.com/300x180/667eea/ffffff?text=Learning+Module";
                  ...
                  >
                    {module.videoCount > 0
                      ...
                      : module.type === "series" ? "Series" : "Video"}
                  </Badge>
                </div>
        ...
        <Alert variant="warning" className="text-center">
          ...
          <p>There are no learning modules available. Please check back later.</p>
        </Alert>
      )}
