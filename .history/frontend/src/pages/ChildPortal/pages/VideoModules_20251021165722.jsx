...
const VideoModules = () => {
  ...
  // In VideoModules.jsx - Update the handleSeriesClick function
  const handleSeriesClick = (seriesItem) => {
    // Navigate to the series introduction page using module route
    navigate(`/child/module/series/${seriesItem.id}/introduction`);
  };

  // Alternative: Navigate to series detail (if you want both options)
