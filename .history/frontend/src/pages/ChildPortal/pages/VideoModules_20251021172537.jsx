...
const VideoModules = () => {
  ...
  // Handle module click - Navigate to ModuleIntroduction for structured learning
  const handleModuleClick = (item) => {
    if (item.type === "series") {
      // Navigate to series module introduction
      navigate(`/child/module/series/${item.id}/introduction`);
    } else {
      // Navigate to single video module introduction
      navigate(`/child/module/single/${item.id}/introduction`);
    }
  };

  // Handle view details - Navigate to content browsing
