...
import { FaArrowLeft, FaPlay, FaVideo, FaClock, FaRedo, FaListUl } from "react-icons/fa";
...
const VideoWatch = () => {
  const { videoSlug, seriesSlug } = useParams();
  ...
  useEffect(() => {
    const fetchVideoData = async () => {
      try {
        ...
        // Check if we have video data from location state (for series videos)
        ...
        // For single videos, fetch from API
    ...
    fetchVideoData();
  }, [videoSlug, seriesSlug, location.state]);
  ...
  const handleRecommendedClick = async (video) => {
    try {
      ...
      const newVideoSlug = createSlug(video.title) || `${video.id}-${createSlug(video.title)}`;
      navigate(`/child/browse/singles/${newVideoSlug}`);
    } catch (error) {
      ...
      <Container fluid className="py-4">
        <Alert variant="danger" className="text-center">
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-center">
            ...
            <Button variant="primary" onClick={seriesSlug ? handleBackToSeries : handleBackToBrowse}>
              {seriesSlug ? "Back to Series" : "Back to Videos"}
            </Button>
          </div>
        </Alert>
      </Container>
  ...
  return (
    <Container fluid className="py-4" style={{ maxWidth: "1400px" }}>
        ...
        <Col>
          <div className="d-flex align-items-center gap-3">
            <Button
              ...
              onClick={seriesSlug ? handleBackToSeries : handleBackToBrowse}
      ...
      <Row>
              ...
              {videoUrl ? (
                ...
                >
                  ...
                  <Alert variant="warning" className="text-center">
                    ...
                    <p className="mb-0">The video file is currently unavailable.</p>
                  </Alert>
                </div>
              )}
            </div>
              ...
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div className="flex-grow-1">
                  <div className="d-flex align-items-center gap-3 mb-2">
                    ...
                    <Badge bg={videoType === "series" ? "primary" : "success"} className="fs-6">
                      {videoType === "series" ? (
                  ...
                  <div className="d-flex align-items-center gap-4 text-muted">
                    ...
                    {currentVideo.created_at && (
                      <span>Uploaded: {formatDate(currentVideo.created_at)}</span>
                    )}
                  </div>
                </div>
              </div>
        ...
        {/* Recommended Videos Sidebar - Only show for single videos */}
        {videoType === "single" && (
          <Col lg={4}>
                ...
                <Card.Body style={{ maxHeight: "600px", overflowY: "auto" }}>
                  {recommendedVideos.length > 0 ? (
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-muted mb-0">No recommended videos available</p>
                    </div>
                  )}
                </Card.Body>
              </Card>
