...
import { FaVolumeUp, FaPlay, FaArrowLeft, FaArrowRight } from "react-icons/fa";
...
const ModuleIntroduction = () => {
  ...
  const handleNext = () => {
    ...
    navigate(`/child/series/${seriesId}/practice/${videoId}`);
  };
    ...
    >
      ...
      >
        ...
        <div className="mt-4 p-3 bg-light rounded-3">
          <h6 className="fw-bold mb-2">🎯 Learning Objectives:</h6>
          <ul className="mb-0">
            <li>Understand the key concepts of this lesson</li>
            <li>Prepare for the video content</li>
            <li>Get ready for interactive practice activities</li>
            <li>Build foundational knowledge for the quiz</li>
          </ul>
        </div>

        {/* Voice Note and Navigation */}
