...
const VideoWatch = () => {
        ...
        if (videoSlug) {
          ...
          if (videoIdMatch) {
            ...
            videoData = allVideos.find(video => 
              createSlug(video.title) === videoSlug
            );
          }
        }
  ...
  const handleRecommendedClick = async (recommendedVideo) => {
    try {
      ...
      // Navigate with slugs
      const moduleSlug = createSlug(recommendedVideo.module_name || `module-${recommendedVideo.module_id}`);
      const videoSlug = createSlug(recommendedVideo.title || `video-${recommendedVideo.id}`);
