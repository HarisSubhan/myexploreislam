...
import { getAllVideosApi, getVideoByIdApi } from "../../services/videoApi"; // ✅ Add getVideoByIdApi
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-5">
        <Badge bg={isSingleVideo ? "success" : "primary"} className="fs-6 mb-3 px-3 py-2">
          ...
          >
            <Card.Body className="p-5">
              ...
              >
                {isSingleVideo 
                  ? "VIDEO INTRODUCTION" 
                  : (series?.name ? series.name.toUpperCase() : "SERIES INTRODUCTION")}
              </h3>
              ...
              <div className="mb-4">
                {isSingleVideo ? (
                  ...
                  >
                    Welcome to this educational video! You'll learn important concepts 
                    through engaging content and test your knowledge with an interactive quiz. 
                    Get ready to enhance your learning experience!
                  </p>
                ) : (
                  <div
                    style={{
          ...
          <Card className="mt-4 border-warning">
            <Card.Body>
              <small className="text-muted">
                ...
                {isSingleVideo ? "Video" : "Series"}: {isSingleVideo ? selectedVideo?.title : series?.name} | <br />
