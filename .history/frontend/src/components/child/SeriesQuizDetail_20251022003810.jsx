...
const SeriesQuizDetail = () => {
  ...
  // ✅ UPDATED: Video click handler - Now goes to ModuleIntroduction
  // SeriesQuizDetail mein handleVideoClick
  const handleVideoClick = (video) => {
    navigate(`introduction`, {
      state: {
        ...
        seriesData: series,
        currentVideo: video,
        videoId: video.id, // ✅ Ensure videoId is passed
      },
    });
  };
              ...
              {videos.map((video, index) => (
                <Col xs={12} md={6} lg={4} key={video.id}>
                  <Card
                    ...
                    onClick={() => handleVideoClick(video)} // ✅ Now goes to ModuleIntroduction
                  >
                    ...
                    <Card.Body>
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <Button variant="outline-primary" size="sm">
                          Start Module {/* ✅ Button text change */}
                        </Button>
                      </div>
                    </Card.Body>
                  </Card>
