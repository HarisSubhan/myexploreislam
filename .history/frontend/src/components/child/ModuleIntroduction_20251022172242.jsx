        ...
        <Col md={10} lg={8}>
          ...
          >
            <Card.Body className="p-5">
              ...
              {/* Description */}
              <div className="mb-4">
                {selectedVideo?.description || "Welcome to this educational video! You'll learn important concepts through engaging content and test your knowledge with an interactive quiz. Get ready to enhance your learning experience!"}
  </p>
                ) : (
                  <div
                    style={{
