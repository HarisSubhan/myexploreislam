...
const AdminCoupons = () => {
    ...
    try {
      ...
      const apiData = {
        ...
        subscription_id: formData.subscription_id
          ? parseInt(formData.subscription_id)
          : null,
      };
  ...
  const isCouponValid = (coupon) => {
    ...
    return (
      coupon.status === "ACTIVE" && today >= validFrom && today <= validUntil
    );
  };
                  ...
                  >
                    ...
                    <td>
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item onClick={() => openEditModal(coupon)}>
                            Edit
                          </Dropdown.Item>
                          <Dropdown.Item
        ...
        <Form.Group>
          ...
          <InputGroup>
            <Form.Control
              ...
              placeholder={
                formData.discount_type === "percentage" ? "50" : "25"
              }
              required
            />
            <InputGroup.Text>
