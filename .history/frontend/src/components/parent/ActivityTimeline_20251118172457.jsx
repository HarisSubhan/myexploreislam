...
const ActivityTimeline = ({ data, loading }) => {
  ...
  const getFilteredActivities = () => {
    ...
    // If user has children data, filter by child IDs
    ...
    // If no children filter, return all activities
    return data;
  };
      ...
      <Card.Body className="p-0">
        <div className="activity-list">
          {filteredActivities.slice(0, 10).map((activity, index) => {
            ...
            const isLast = index === Math.min(filteredActivities.length, 10) - 1;
                  ...
                  <div className="d-flex justify-content-between align-items-start mb-1">
                    <div>
                      <h6 className="mb-0 fw-semibold small">
                        {activity.child_name || activity.childName || "Student"}
                      </h6>
        ...
        {filteredActivities.length > 10 && (
          <div className="text-center py-3 border-top">
            <small className="text-muted">
              Showing latest 10 of {filteredActivities.length} activities
            </small>
          </div>
        )}
      </Card.Body>
