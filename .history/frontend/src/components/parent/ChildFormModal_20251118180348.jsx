...
const AVAILABLE_AVATARS = [
  ...
  { id: "avatar4", icon: <FaUserAlt size={30} />, color: "#ffc107", label: "Child 4" },
  { id: "avatar5", icon: <FaSmile size={30} />, color: "#6f42c1", label: "Child 5" },
  { id: "avatar6", icon: <FaBaby size={30} />, color: "#fd7e14", label: "Child 6" }
];
