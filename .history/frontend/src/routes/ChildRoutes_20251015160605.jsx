    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Routes>
        <Route path="/" element={<ChildApp />}>
          ...
          <Route path="single" element={<CartoonModules />} />
          <Route path="cartoon/single/:id" element={<VideoWatch />} />

          {/* FIXED */}
          <Route path="series" element={<VideoModules />} />
          <Route path="series/series/:id" element={<VideoSeries />} />
          <Route
            path="/child/series/series/:seriesId/video/:videoId/introduction"
            element={<ModuleIntroduction />}
          />
          <Route path="series/series/:id/page1" element={<ModulePage1 />} />
          <Route path="series/series/:id/quiz" element={<ModuleQuiz />} />
          <Route
            path="series/series/:id/completion"
