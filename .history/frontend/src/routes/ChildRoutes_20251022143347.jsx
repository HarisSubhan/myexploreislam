      ...
      <Routes>
        <Route path="/" element={<ChildApp />}>
          ...
          <Route path="module">
            ...
            {/* ✅ FIXED: Single route for ModulePage1 with videoId parameter */}
            <Route
            ...
            <Route
              ...
              element={<ModuleIntroduction />}
            />
            {/* ❌ REMOVE THIS DUPLICATE ROUTE - It's conflicting */}
            {/* <Route path=":seriesSlug/page1/:videoId?" element={<ModulePage1 />} /> */}
