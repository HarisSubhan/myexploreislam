  ...
  return (
    <Container className="child-video-container py-4">
      ...
      {filteredVideos.length > 0 ? (
        ...
        <div className="no-videos-container text-center py-5">
          <div className="no-videos-content">
            <img 
              src="https://cdn-icons-png.flaticon.com/512/4076/4076478.png" 
              alt="No videos" 
              className="no-videos-image mb-4"
              style={{ width: "150px", opacity: 0.7 }}
            />
            <h3 className="no-videos-title mb-3" style={{ color: "#666" }}>
              No videos found right now 🧐
            </h3>
            <p className="no-videos-message mb-4" style={{ color: "#888" }}>
              It looks like there are no videos available in this category.
              <br />
