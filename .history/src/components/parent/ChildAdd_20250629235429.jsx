...
// Define your base URL (you might want to put this in a config file)
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        setErrorMessage(error.message || 'Failed to create child account. Please try again.');
      } finally {
