...
import './ColorChanging.css'; // Create this file for custom styles
...
const ColorChanging = () => {
  ...
  const handleColorChange = (colorValue, colorName, textColor) => {
    ...
    // You can add more CSS variables here for other theme aspects
  };
  ...
  useEffect(() => {
    ...
    const currentColor = colorOptions.find(opt => opt.value === themeColor) || colorOptions[0];
        ...
        <Card.Body>
          <Row className="justify-content-center">
            {colorOptions.map((color) => (
              <Col key={color.value} xs={6} sm={4} md={3} lg={2} className="mb-4">
                <div
                  ...
                  style={{
                    ...
                    border: themeColor === color.value ? '3px solid var(--text-on-primary)' : '2px solid #dee2e6',
                  }}
                >
                  {color.name}
                </div>
          ...
          <div className="text-center mt-4">
            <Button 
              ...
              onClick={() => {
                ...
                handleColorChange(defaultColor.value, defaultColor.name, defaultColor.textColor);
              }}
            >
              Reset to Default
            </Button>
