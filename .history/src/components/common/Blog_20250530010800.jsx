          ...
          <Card className="shadow-sm h-100 border-0">
            ...
            <Card.Body>
              <Card.Title style={{ color: "#F1066C" }}>
                5 Fun Ways Kids Learn Faster
              </Card.Title>
              <Card.Text>
                Discover engaging learning techniques for children using
                stories, colors, and interactivity!
              </Card.Text>
              <Button style={{ backgroundColor: "#F1066C" }} size="sm">
                Read More
              </Button>
            </Card.Body>
          </Card>
        ...
        <Col xs={12} md={6} lg={4}>
          <Card className="shadow-sm h-100 border-0">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Learn how art, play, and storytelling make lessons unforgettable
                for young minds.
              </Card.Text>
              <Button style={{ backgroundColor: "#F1066C" }} size="sm">
                Read More
        ...
        <Col xs={12} md={6} lg={4}>
          <Card className="shadow-sm h-100 border-0">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Explore safe and smart ways to integrate technology into your
