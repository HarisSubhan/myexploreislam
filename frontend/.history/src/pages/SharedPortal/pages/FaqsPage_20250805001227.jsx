...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely. If you’re a new Muslim or returning to Islamic teachings and want your child to start learning with you, Explore Islam provides a gentle, structured path to start building Islamic
knowledge together"
    }
  ];
