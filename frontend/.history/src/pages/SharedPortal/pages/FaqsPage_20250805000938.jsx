...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "We cover topics like the Five Pillars of Islam, stories of the Prophets, good manners (Akhlaq), understanding Allah’s names, and more - all taught through storytelling, activities, and child-appropriate explanations"
    },
  ];
