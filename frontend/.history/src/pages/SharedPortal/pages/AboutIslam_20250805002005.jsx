...
const AboutIslam = () => {
  return (
    <Container className="py-5">
      <Row className="mb-4">
        <Col>
          <h2 style={{ color:  }} className="text-center fw-bold">About Islam</h2>
      ...
      <Row className="mb-5">
        <Col>
          <h3 className="fw-semibold text-primary mb-3 text-center">
      ...
      <Row className="mb-4">
        <Col>
          <h3 className="fw-semibold text-success mb-3 text-center">
