...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We combine visual storytelling, child-friendly language, and interactive tools in one place. The
cartoon series Maryam and Muaz is unique to our platform and helps children connect
