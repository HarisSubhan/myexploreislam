...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, you can create multiple child profiles under one parent account. Each child can go through
the modules at their own pace and have separate progress tracking"
    },
  ];
