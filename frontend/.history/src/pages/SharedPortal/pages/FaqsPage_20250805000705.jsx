...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! Explore Islam is perfect for homeschooling families looking for structured, child-friendly Islamic education. Our platform covers essential Islamic topics in a way that keeps kids excited
to learn, while helping parents stay involved",
    },
    {
