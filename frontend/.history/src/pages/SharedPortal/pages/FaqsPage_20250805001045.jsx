...
const FaqsPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. Parents can create a separate login to track their child’s learning progress, quiz scores,and lesson completion. This helps you stay involved in their Islamic education and support theirgrowth."    },
  ];
