  ...
  return (
    ...
    >
      ...
      <Nav className="flex-column mt-4">
        ...
        <Nav.Link as={Link} to="/admin/Support" className="text-white">
          <BiSolidCategory /> Support
        </Nav.Link>
        <Nav.Link as={Link} to="/admin/coupons" className="text-white">
          <BiSolidCategory /> Coupons
        </Nav.Link>
        <Nav.Link as={Link} to="/admin/categories" className="text-white">
          <FaTrashAlt /> Trash
        </Nav.Link>
