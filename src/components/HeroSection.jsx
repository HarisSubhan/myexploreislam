...
import MaryamMuazImage from '../assets/images/Maryam___Muaz.png';
import DecorativeImage from '../assets/images/c.png';
...
const HeroSection = () => {
  return (
    <div className="hero-wrapper" style={{ 
      ...
      <Container fluid className="hero-section" style={{ 
        ...
        <Row className="align-items-center h-100 g-0">
          ...
          <Col lg={6} className="text-center text-lg-start px-4 px-lg-5 order-lg-2 order-1" style={{ zIndex: 2 }}>
            <div className="mb-4">
              <h1 className="display-3 fw-bold text-uppercase mb-3" style={{ color: "#2a5f73" }}>
                MARYAM & MUAZ
              </h1>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, rgba(47, 170, 64, 1) 0%, rgba(11, 165, 18, 0.7) 100%)',
          zIndex: 1
        }}></div>
      </Container>
      <div>
